...
glimmer.setup({
  ...
  animations = {
    ...
    custom = {
      ...
      effect = function(self, progress) return self.settings.color, progress end,
    },
  },
...
vim.keymap.set('n', '<leader>tg', glimmer.toggle, { desc = 'Toggle yank/paste and other animations' })
